...
function requiredFalse() {
    const campos = document.getElementById("detalles-form").querySelectorAll("select, input");
    ...
    .addEventListener("change", function () {
        ...
        switch (this.value) {
            case "1":
                ...
                campos = document.getElementById("abast_agua").querySelectorAll("select, input");
            ...
            case "2":
                ...
                campos = document.getElementById("apoyo_unid").querySelectorAll("select, input");
            ...
            case "3":
                ...
                campos = document.getElementById("guard_prev").querySelectorAll("select, input");
                setRequired(campos, true);
                document.getElementById("button_submit").style.display = "block";
                break;
            case "4":
                ...
                campos = document.getElementById("atend_no_efect").querySelectorAll("select, input");
                setRequired(campos, true);
                document.getElementById("button_submit").style.display = "block";
                break;
            case "5":
                ...
                campos = document.getElementById("desp_seguridad").querySelectorAll("select, input");
                setRequired(campos, true);
                document.getElementById("button_submit").style.display = "block";
                break;
            case "6":
                ...
                campos = document.getElementById("falsa_alarm").querySelectorAll("select, input");
                setRequired(campos, true);
                document.getElementById("button_submit").style.display = "block";
                break;
            case "7":
                ...
                document
                    ...
                    .addEventListener("change", function () {
                        ...
                        if (this.value === "Emergencias Medicas") {
                            ...
                            let emergenciaCampos = document.getElementById("emergencias_medicas").querySelectorAll("select, input");
                            let accidentesTransito = document.getElementById("accidentes_transito").querySelectorAll("select, input");
                            let emergenciaCampos_no = document.getElementById("emergencias_medicas").querySelectorAll("input[type='checkbox']");

                            setRequired(emergenciaCampos, true);
                            requiredExceptions(emergenciaCampos_no)
                            requiredExceptions(accidentesTransito)

                            document.getElementById("traslados_emergencias").querySelectorAll("select, input").forEach(ele => {
                            ...
                            document
                                ...
                                .addEventListener("change", function () {
                                    ...
                                    if (this.checked) {
                                        document.getElementById("traslados_emergencias").style.display = "block";
                                        document.getElementById("traslados_emergencias").querySelectorAll("select, input").forEach(ele => {
                                            ele.setAttribute("required", true)
                                        });;
                                    } else {
                                        document.getElementById("traslados_emergencias").style.display = "none";
                                        document.getElementById("traslados_emergencias").querySelectorAll("select, input").forEach(ele => {
                                            ele.removeAttribute("required")
                                        });;
                                    }
                            ...
                            let accidenteCampos = document.getElementById("accidentes_transito").querySelectorAll("select, input");
                            let emergenciaCampos = document.getElementById("emergencias_medicas").querySelectorAll("select, input");
                            let accidenteCampos_no = document.getElementById("accidentes_transito").querySelectorAll("input[type='checkbox']");

                            setRequired(accidenteCampos, true);
                            requiredExceptions(accidenteCampos_no)
                            requiredExceptions(emergenciaCampos)

                            requiredExceptions(document.getElementById("vehiculo_accidente").querySelectorAll("select, input"));
                            requiredExceptions(document.getElementById("otro_vehiculo_accidente").querySelectorAll("select, input"));
                            requiredExceptions(document.getElementById("lesionado_accidente").querySelectorAll("select, input"));
                            requiredExceptions(document.getElementById("traslado_accidente").querySelectorAll("select, input"));
                            requiredExceptions(document.getElementById("otro_vehiculo_accidente2").querySelectorAll("select, input"));

                            document
                                .getElementById("id_formulario_accidentes_transito-agg_vehiculo")
                                .addEventListener("change", function () {
                                    if (this.checked) {
                                        document.getElementById("vehiculo_accidente").style.display = "block";
                                        document.getElementById("vehiculo_accidente").querySelectorAll("select, input").forEach(ele => {
                                            ele.setAttribute("required", true)
                                        });;
                                    } else {
                                    ...
                                    document
                                        .getElementById("id_detalles_vehiculos_accidentes-agg_vehiculo")
                                        .addEventListener("change", function () {
                                            if (this.checked) {
                                                document.getElementById("otro_vehiculo_accidente").querySelectorAll("select, input").forEach(ele => {
                                                    ele.setAttribute("required", true)
                                                });;
                                                document.getElementById("otro_vehiculo_accidente").style.display = "block";
                                            } else {
                                                document.getElementById("otro_vehiculo_accidente").querySelectorAll("select, input").forEach(ele => {
                                                    ele.removeAttribute("required")
                                                });;
                                                document.getElementById("otro_vehiculo_accidente").style.display = "none";
                                            }
                                        });
                                        document
                                            .getElementById("id_detalles_vehiculos_accidentes2-agg_vehiculo")
                                            .addEventListener("change", function () {
                                                if (this.checked) {
                                                    document.getElementById("otro_vehiculo_accidente2").querySelectorAll("select, input").forEach(ele => {
                                                        ele.setAttribute("required", true)
                                                    });;
                                                    document.getElementById("otro_vehiculo_accidente2").style.display = "block";
                                                } else {
                                                    document.getElementById("otro_vehiculo_accidente2").querySelectorAll("select, input").forEach(ele => {
                                                        ele.removeAttribute("required")
                                                    });;
                                                    document.getElementById("otro_vehiculo_accidente2").style.display = "none";
                                                }
                                            });
                                });

                            document
                                .getElementById("id_formulario_accidentes_transito-agg_lesionado")
                                .addEventListener("change", function () {
                                    if (this.checked) {
                                        document.getElementById("lesionado_accidente").querySelectorAll("select, input").forEach(ele => {
                                            ele.setAttribute("required", true)
                                        });;
                                        document.getElementById("lesionado_accidente").style.display = "block";

                                    } else {
                                        document.getElementById("lesionado_accidente").querySelectorAll("select, input").forEach(ele => {
                                            ele.removeAttribute("required")
                                        });;
                                        document.getElementById("lesionado_accidente").style.display = "none";
                                    }

                                    document
                                        .getElementById("id_detalles_lesionados_accidentes-trasladado")
                                        .addEventListener("change", function () {
                                            if (this.checked) {
                                                document.getElementById("traslado_accidente").querySelectorAll("select, input").forEach(ele => {
                                                    ele.setAttribute("required", true)
                                                });;
                                                document.getElementById("traslado_accidente").style.display = "block";
                                            } else {
                                                document.getElementById("traslado_accidente").querySelectorAll("select, input").forEach(ele => {
                                                    ele.removeAttribute("required")
                                                });;
                                                document.getElementById("traslado_accidente").style.display = "none";
                                            }
            ...
            case "9":
                ...
                campos = document.getElementById("serv_especiales").querySelectorAll("select, input");
                setRequired(campos, true); // Agregar required a la nueva sección
                document.getElementById("button_submit").style.display = "block";
                break;
            case "10":
            ...
            default:
                elementosOcultar.forEach(id => {
                    ...
                    campos = document.getElementById(id).querySelectorAll("select, input");
